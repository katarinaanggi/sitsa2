<form class="form-horizontal" id="createbrand" method="post" enctype="multipart/form-data" onsubmit="update({{ $brand->id }}); return false;">
  <div class="row g-2">
    <div class="col mb-3">
      <div class="row g-2 mb-3">
        <label for="prev" class="form-label">Gambar Disimpan :</label>
        <img id="prev" src="{{ url('uploads/brands/'.$brand->gambar) }}" width="200px"/>
      </div>
      <div class="row g-2">
        {{-- input Gambar --}}
  ...
  <div class="row g-2">
    <div class="col mb-3">
      ...
      <input type="text" id="name" class="form-control" value="{{ $brand->nama }}" placeholder="Masukkan Name" />
